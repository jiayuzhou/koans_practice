...
class AboutBlocks < Neo::Koan
  ...
  def test_block_can_affect_variables_in_the_code_where_they_are_created
    value = :initial_value
    a = method_with_block { value = :modified_in_a_block }
    assert_equal :modified_in_a_block, value
    assert_equal :modified_in_a_block, a 
    # Jiayu note: the value is changed in the block, 
    #     and then passed into the the function.   
  end
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    # Jiayu Note: this is some kind of function pointer. 
