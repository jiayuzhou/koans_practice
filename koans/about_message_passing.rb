...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # sometimes we will need to override the name `send`
  end
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    # ok this strange method "method_missing" make it possible to deal 
    # with all undefined methods without exceptions, ... but still not 
