...
EOS
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified
    ...
    there = "World"
    hi += there
    # original_string and hi initially have the same object_id. 
    # when doing hi += there, hi is assigned to a new object. 
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Jiayu Note: maybe this changes all String instances? 
  end
